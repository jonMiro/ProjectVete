    ...
    <form @submit.prevent="submitForm" class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="relative z-0 w-full group">
          <input v-model="form.name" type="text" id="name" name="name" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <!-- Apellidos -->
        <div class="relative z-0 w-full group">
          <input v-model="form.apellidos" type="text" id="apellidos" name="apellidos" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <!-- Correo Electrónico -->
        <div class="relative z-0 w-full group">
          <input v-model="form.email" type="email" id="email" name="email" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          <label for="email" class="peer-focus:font-medium absolute text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:text-blue-600">Correo electrónico</label>
          <div v-if="form.errors.email" class="text-red-500 text-sm mt-1">{{ form.errors.email }}</div>
        </div>

        <!-- Teléfono -->
        <div class="relative z-0 w-full group">
          <input v-model="form.telefono" type="text" id="telefono" name="telefono" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <!-- Dirección -->
        <div class="relative z-0 w-full group">
          <input v-model="form.direccion" type="text" id="direccion" name="direccion" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
...
<div class="relative z-0 w-full group">
  ...
  <select v-model="form.tipo" id="tipo" name="tipo" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer">
...
<div class="relative z-0 w-full group">
  ...
  <div v-if="form.errors.is_worker" class="text-red-500 text-sm mt-1">{{ form.errors.is_worker }}</div>
        ...
        <!-- Contraseña -->
        <div class="relative z-0 w-full group">
          <input v-model="form.password" type="password" id="password" name="password" class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
      ...
      <div class="text-yellow-600 mt-2 text-lg">
