...
<template>
  <AppLayout title="Detalle del Servicio">
    <template #header>
        ...
        Servicio de {{ servicio.animal.nombre }}
      </h2>
    </template>
    ...
    <div class="container mx-auto mt-10 px-4">
      ...
      <div class=" p-6 rounded-xl shadow-xl max-w-4xl mx-auto mb-8 bg-white">
        ...
        <div class="mb-6">
          <p class="text-lg text-gray-700 text-center"><strong>Fecha:</strong> {{ formatDate(servicio.fecha) }}</p>
      ...
      <div class="mt-6 text-center">
        <Link :href="route('clients.historial.index')" class="bg-blue-500 text-white py-2 px-6 rounded-lg hover:bg-blue-600 transition">
          Volver al historial
        </Link>
      </div>
    </div>
