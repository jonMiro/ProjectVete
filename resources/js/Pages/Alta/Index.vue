  ...
  <AppLayout title="Alta de Registros">
    <template #header>
      ...
      <div v-else-if="currentSection === 'animal'">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Formulario de Alta Animal</h2>
        <FormularioAnimales :clientes="clientes" />
      </div>

      <div v-else-if="currentSection === 'servicio'">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Formulario de Alta Servicio</h2>
        <FormularioServicio :users="users" :animales="animales" :auxiliares="auxiliares"/>
      </div>

      <div v-else-if="currentSection === 'consulta'">
        <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Formulario de Alta Consulta</h2>
