...
// Función para limitar el contenido a un número de palabras
...
<template>
  <AppLayout title="Panel de Posts">
    ...
    <div class="container mx-auto mt-10 px-4">
      <h2 class="text-center text-3xl font-semibold mb-8">Listado de Posts</h2>
      ...
      <div v-if="isListView && (guias.length > 0 || anuncios.length > 0 || experiencias.length > 0)" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- Repetir el proceso para anuncios y experiencias de la misma forma -->
